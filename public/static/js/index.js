        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(result,function(n,value) {
                    str += '<ul class="d-firstDrop s-firstDrop"> <li> <div class="d-secondNav s-secondNav" data-v="'+ value.id +'">';
                    str += ' <i class="fa fa-minus-square-o"></i> <span><a href="#" class="mdspan" data-ids="'+value.id+'">'+value.name + '</a></span>'
                    str += '<i class="fa fa-caret-right fr"></i></div> <ul class="d-secondDrop s-secondDrop"> <li class="s-thirdItem"><a href="#"></a> </li> </ul> </li> </ul>';
