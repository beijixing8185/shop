        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <a href="{{url('hx/admin/addAbout')}}" class="label label-primary">添加</a>
              </h3>
            ...
            <thead>
                ...
                <tr role="row" class="odd">
                      ...
                      <td><a href="{{url('hx/admin/addAbout',['id'=>$g->id])}}" class="fa fa-edit" title="编辑"style="margin-left: 10px;" ></a></td>
...
<script>
    ...
    $('#example2').on('click','.delSpec',function(){
        ...
        var resultUrl = '/hx/admin/delAbout?id='+ Id;
        if(confirm('确定要删除吗?')){
