        ...
        <div class="col-xs-12">
          ...
          <div>
            <div class="box-header with-border">
                ...
                <h3 class="box-title">
                    <a href="{{url('hx/admin/addArticleCates')}}" class="label label-primary" style="font-size:100%;">添加</a>
                </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                          ...
                          @foreach($cate as $c)
                              <li class="first">
                                  <div class="d-firstNav s-firstNav clearfix" data-id="{{$c->id}}">
                                      ...
                                      <span ><a href="#" class="mdspan" data-ids="{{$c->id}}">{{$c->cate_name}}</a></span>
...
<script type="text/javascript" src="/static/js/articleCate.js" ></script>
