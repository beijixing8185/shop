      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{url('hx/admin/addCase')}}" method="post"  class="form-horizontal" enctype="multipart/form-data" onsubmit="return checkSubmit();">
        {!!csrf_field()!!}
                        ...
                        <select name="cate_two" class="cate_two" id="cate_two" >
                            @if(!empty($cates))
                                @foreach($cates as $k=>$v)
                                    <option value="{{$k}}"  @if($k == $case->spu_id) selected @endif> {{ $v }}</option>
                                @endforeach
                            @endif
                        </select>
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">成交价格:</label>

                    <div class="col-sm-2">
                        <input type="text" class="form-control" placeholder="涉及金额,6980元/首年" name="money"  id="money" value="{{$case->money}}" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" placeholder="请填写周期,比如,14天" name="day"  id="day" value="{{$case->day}}" >
                        <span class="title" style="color:red"></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" placeholder="案例客户名称" class="form-control" name="customer" id="customer" value="{{$case->customer}}" >
                        <span class="price" style="color:red"></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="status" id="status">
                        ...
                        <option value="1" @if($case->status == 1) selected @endif>有效</option>n>
                </select>
                </div>
                </div>
