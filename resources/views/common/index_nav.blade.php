    ...
    <div class="banner-nav container">
        <div class="banner-nav-inner" id="bannerWaper">
            <ul class="banner-nav-list" id="bannerSerList">
                <li data-toggle="catInfo1">
                    <div class="banner-nav-list-title"><p class="ban-nav-logo00"></p>微信营销<b class="ban-nav-pointer"></b></div>
                    <ul class="banner-baob">
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/376.htm?_pb=dhwx1' target="_blank">微信代运营</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/457.htm?_pb=dhwx2' target="_blank">订阅号搭建</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/428.htm?_pb=dhwx3' target="_blank">朋友圈广告</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/430.htm?_pb=dhwx4' target="_blank">广点通广告</a></li>
                    </ul>
                </li>
                <li data-toggle="catInfo2">
                    <div class="banner-nav-list-title"><p class="ban-nav-logo01"></p>开发建站<b class="ban-nav-pointer"></b></div>
                    <ul class="banner-baob">
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/370.htm?_pb=dhjz1' target="_blank">网站定制开发</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/429.htm?_pb=dhjz2' target="_blank">模板建站</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/423.htm?_pb=dhjz3' target="_blank">公众号定制</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/438.htm?_pb=dhjz4' target="_blank">小程序定制</a></li>
                    </ul>
                </li>
                <li data-toggle="catInfo3">
                    <div class="banner-nav-list-title"><p class="ban-nav-logo02"></p>新闻/文案<b class="ban-nav-pointer"></b></div>
                    <ul class="banner-baob">
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/367.htm?_pb=dhxw1' target="_blank">软文写作</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/387.htm?_pb=dhxw2' target="_blank">论坛发帖</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/366.htm?_pb=dhxw3' target="_blank">品牌文案</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/419.htm?_pb=dhxw4' target="_blank">媒体发稿</a></li>
                    </ul>
                </li>
                <li data-toggle="catInfo4">
                    <div class="banner-nav-list-title"><p class="ban-nav-logo03"></p>口碑营销<b class="ban-nav-pointer"></b></div>
                    <ul class="banner-baob">
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/427.htm?_pb=dhkb1' target="_blank">百度百科</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/405.htm?_pb=dhkb2' target="_blank">百度知道</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/397.htm?_pb=dhkb3' target="_blank">微整合营销</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/432.htm?_pb=dhkb4' target="_blank">口碑营销</a></li>
                    </ul>
                </li>
                <li data-toggle="catInfo5">
                    <div class="banner-nav-list-title"><p class="ban-nav-logo04"></p>推广/设计<b class="ban-nav-pointer"></b></div>
                    <ul class="banner-baob">
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/378.htm?_pb=dhtg1' target="_blank">SEO优化</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/383.htm?_pb=dhtg2' target="_blank">SEM竞价托管</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/450.htm?_pb=dhtg3' target="_blank">高端名片设计</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/453.htm?_pb=dhtg4' target="_blank">LOGO设计</a></li>
                    </ul>
                </li>
                <li data-toggle="catInfo6">
                    <div class="banner-nav-list-title"><p class="ban-nav-logo05"></p>广告投放<b class="ban-nav-pointer"></b></div>
                    <ul class="banner-baob">
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/222.htm' target="_blank">移动端广告</a></li>
                        <li class=""><a style="color:#f1f3f6;font-size:12px" href='http://www.51biaoshi.com/product/350.htm' target="_blank">信息流广告</a></li>
                    </ul>
                </li>
            </ul>
            <div class="banner-list-con">
                <div  class="banner-list-inner" id="catInfo1" style="display:none">
                ...
                <div  class="banner-list-inner" id="catInfo2" style="display:none">
                    <div  class="pull-left banner-list">
                ...
                <div  class="banner-list-inner" id="catInfo3" style="display:none">
                    <div  class="pull-left banner-list">
                ...
                <div  class="banner-list-inner" id="catInfo4" style="display:none">
                    <div  class="pull-left banner-list">
                ...
                <div  class="banner-list-inner" id="catInfo5" style="display:none">
                    <div  class="pull-left banner-list">
                ...
                <div  class="banner-list-inner" id="catInfo6" style="display:none">
                    <div  class="pull-left banner-list">
        ...
        <style>
            ...
            .adviceRight .adviceRightTitle{
                font-size: 20px;
                color: #fff;
                margin-bottom: 5px;
            }
            .adviceRight .adviceRightInfo{
                font-size: 14px;
                color: #fff;
            }
            .adviceRight .adviceRightInfo span{
                color: #f07247;
            }
            .adviceRight .adviceRightSubmit{
                position: absolute;
                top: 22px;
                right: 20px;
            }
            .adviceRight .adviceRightSubmit span{
            ...
            .adviceRight .adviceRightSubmit span:hover{
        ...
        <div class="adviceRight">
            ...
            <div class="adviceRightInfo">镖狮今天已为<span> 322 </span>人提供营销咨询</div>
            <div class="adviceRightSubmit">
                <span id="bannerIM" class="caClass" traceflag="content_im_首页banner在线咨询" onclick="javascript:openBDBridge();">在线咨询</span>
            </div>
        </div>
    </div>
</div>