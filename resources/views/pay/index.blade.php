...
@section('content')
    ...
    <div class="container buy-session">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="orderPay">
                <div class="container">
					<input type="hidden" id="isStdProduct" value="">
                ...
                <div class="buy-success">
                    ...
                    <span>服务商已收到您的订单，
                                        	将在工作日(9:30-18:30)使用170开头电话与您联系，请保持手机畅通。
                                                           ...
                                                           镖狮网保障您的服务效果，保护您的信息隐私安全，如有疑问请致电010-53526642。
	    ...
	    <div class="bank-inner">
	        ...
	        <dl class="bank-info">
	            ...
	            <dd class="pull-left">
	                <p class="red-wining"><span>汇款识别码</span></p>
	...
	<div id="errorPromptDiv" class="buySureShadow" style="display:none">
	    ...
	    <div class="shade">
	        ...
	        <div class="describe">
	            <p class="des-money">实付金额：<span>元</span></p>
